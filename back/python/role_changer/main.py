...
async def update_user_roles_route(user_id: str, user_roles: RoleData, x_user_id: Annotated[str | None, Header()] = None,
                                  x_user_role: Annotated[int | None, Header()] = None) -> RoleData | JSONResponse:
