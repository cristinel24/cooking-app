...
async def delete_user(user_id: str):
    ...
    report_collection.update_author_id_by_user_id(user_id)
    report_collection.delete_reported_id_by_user_id(user_id)
    recipe_collection.update_author_id_by_user_id(user_id)
    rating_collection.update_author_id_by_user_id(user_id)
