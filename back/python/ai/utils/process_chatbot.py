...
async def process_chatbot_query(
    ...
    header_preferences_list = ', '.join(saved_recipe_tokens)
    ...
    try:
        ...
        raise AIException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, error_code=ErrorCodes.AI_NOT_RESPONSIVE)
